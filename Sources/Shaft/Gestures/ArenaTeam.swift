...
private class CombiningGestureArenaMember: GestureArenaMember {

    //   _CombiningGestureArenaMember(this._owner, this._pointer);
    init(team: GestureArenaTeam, pointer: Int) {
        self.owner = team
        self.pointer = pointer
    }

    var owner: GestureArenaTeam
    ...
    //   }
    func add(_ pointer: Int, _ member: GestureArenaMember) -> GestureArenaEntry {
        fatalError()
    }
...
class GestureArenaTeam {
    ...
    private var _combiners = [Int: CombiningGestureArenaMember]()
    ...
    var captain: GestureArenaMember?
    ...
    public func add(_ pointer: Int, _ member: GestureArenaMember) -> GestureArenaEntry {
        let combiner = _combiners.putIfAbsent(
            pointer,
            { CombiningGestureArenaMember(team: self, pointer: pointer) }
        )
